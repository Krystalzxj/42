...
$done({
    title:"𝑺𝒖𝒓𝒈𝒆 𝑷𝒓𝒐 🧚‍♀️   ➺   🏜2023-02-22 \n🐯🐯🐯     已运行"+startTime,
    content:"𝑴𝒊𝒕𝒎:"+icon_status(mitm_status.enabled)+"    𝑹𝒆𝒘𝒓𝒊𝒕𝒆:"+icon_status(rewrite_status.enabled)+"    𝑺𝒄𝒓𝒊𝒑𝒕𝒊𝒏𝒈:"+icon_status(scripting_status.enabled),
    icon: icon_s?"touchid":"exclamationmark.triangle",
   "icon-color":icon_s?"#f20c00":"#FF7500"
});
})();
...
if(days==0){
  if(hours==0){
    ...
    return(`${hours} ᴴ ${minutes} ᴹ ${seconds} ˢ`)
  }else {
